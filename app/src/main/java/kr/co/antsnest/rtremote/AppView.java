...
import kr.co.antsnest.rtremote.grid.AppGridAdapter;
...
public class AppView extends Activity implements AdapterFragmentCallbacks {
    ...
    private void populateAppGridWithCache() {
        try {
            ...
            RtLog.info("Loaded applist from cache");
        } catch (IOException | XmlPullParserException e) {
            if (lastRawApplist != null) {
                RtLog.warning("Saved applist corrupted: "+lastRawApplist);
                e.printStackTrace();
            }
            RtLog.info("Loading applist from the network");
